        ...
        <>
            ...
            >
                ...
                <div className="relative z-10 text-white px-4 py-8 md:px-16">
                    <h2 style={{ fontFamily: 'Nulshock', fontSize: "3rem" }} className="text-6xl my-4 mb-5 text-center">{isroEvent?.title}</h2>
...
<p className="text-md mb-2 text-center" style={{ fontFamily: 'Marcellus' }}>Date: {isroEvent?.date}</p>
<p className="text-md mb-6 text-center" style={{ fontFamily: 'Marcellus' }}>Location: {isroEvent?.location}</p>
<p className="text-md text-center leading-none relative bottom-3" style={{ fontFamily: 'Marcellus' }}>Timings: {isroEvent?.timings}</p>
                </div>
                <div
