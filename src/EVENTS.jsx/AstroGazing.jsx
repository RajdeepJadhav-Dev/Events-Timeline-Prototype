...
export default function AstroGazing() {
    const astroGazingEvent = Events.find(event => event.title === 'Astro-Gazing 2024');
        ...
        <>
            ...
            >
                ...
                <div className="relative z-10 text-white px-4 py-8 md:px-16">
                    ...
                    <div className="overflow-hidden relative w-full">
                        <div className="flex items-center gap-x-4 animate-scroll w-max">
                            {Object.values(astroGazingEvent.gallery).map((image, index) => (
                                <img
                                    key={index}
                                    src={image}
                                    alt={`Astro-Gazing Image ${index + 1}`}
                ...
                >
                    ...
                    {renderOverview(astroGazingEvent.overview)}
                </div>
            </section>
        </>
    );
